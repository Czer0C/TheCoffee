...
// core components
import CustomNavbar from "evolution/components/CustomNavbar.js";
          ...
          categories.length > 0 ?
              <Container>
                <section className="promotion-page">
                  <h1 className="page-header page-title text-center">Thực đơn</h1>
                </section>
                <section className="domino-nav-1">
                  <article>
                    <div className='Module Module-314'>
                            ...
                            <div className='tns-ovh'>
                              <div className='tns-inner'>
                                <ul className="nav nav-slider">
                                  <li className={`nav-item tns-item tns-slide-active ${pills == 0 ? "active" : ""}`}>
                                    <a className="nav-link" onClick={e => {
                                      e.preventDefault();
                                      setPills(pills === 0 ? -1 : 0);
                                      setCurrentList(products)}}>Tất cả</a>
                                  </li>
                                  <li className={`nav-item tns-item tns-slide-active ${pills == 1 ? "active" : ""}`}>
                                    <a className="nav-link" onClick={e => {
                                      e.preventDefault();
                                  ...
                                  <li className={`nav-item tns-item tns-slide-active ${pills == 2 ? "active" : ""}`}>
                                    <a className="nav-link" onClick={e => {
                                      e.preventDefault();
                                  ...
                                  <li className={`nav-item tns-item tns-slide-active ${pills == 3 ? "active" : ""}`}>
                                    <a className="nav-link" onClick={e => {
                                      e.preventDefault();
                                      setPills(pills === 3 ? -1 : 3);
                                      setCurrentList(pills === 3 ?
                                          products :
